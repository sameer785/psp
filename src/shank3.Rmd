...
shank3.abundances.pca.plot <- makePcaPlot(shank3.abundances.clean, as.factor(shank3.sampleSheet$color))
shank3.abundances.pca.plot
ggsave("~/Google Drive/psp/analysis/plots/shank3/pca.pdf", width = 8, height = 6, units = "in")
```
