...
grin2a.abundances.pca.plot <- makePcaPlot(grin2a.abundances.clean, grin2a.sampleSheet$color)
grin2a.abundances.pca.plot
ggsave(filename = "~/Google Drive/psp/analysis/plots/grin2a/pca.pdf", width = 12, height = 8, units = "in")
```
...
grin2a.go <- doGoAnalysis(grin2a.xls, goPathways)
grin2a.go$up
grin2a.go$down
```
```{r}
