...
Plotting genes associated with translation initiation GO
```{r}
rnaProcessing <- str_to_title(trio.go$up$x$data$leadingEdge[[18]]) ### Translation initiaton
...
```{r}
mito <- str_to_title(trio.go$down$x$data$leadingEdge[[4]]) ### Translation initiaton
...
```{r}
syn <- str_to_title(trio.go$down$x$data$leadingEdge[[14]]) ### Translation initiaton
...
```{r}
chromProcessing <- str_to_title(trio.go$up$x$data$leadingEdge[[69]]) ### Translation initiaton
