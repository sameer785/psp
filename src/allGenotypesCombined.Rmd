...
makeAllHetKoPlots(akap11.xls, 67, "akap11")
...
# 
all.xls <- inner_join(trio.xls, shank3.xls, by="id", suffix=c(".trio", ".shank3"))
all.xls <- inner_join(all.xls, grin2a.xls, by="id")
all.xls <- inner_join(all.xls, akap11.xls, by="id")
...
ggsave("~/Google Drive/psp/analysis/plots/combined/abundance_Sfpq_akap11.pdf", width = pWidth, height = pHeight, units="in")
...
akap11.abundances <- akap11.xls %>% dplyr::select(starts_with("Glun2A_PSD_TMT16_Proteome.."))
akap11.sampleSheet <- makeSampleSheet(akap11.abundances)
colnames(akap11.abundances) <- akap11.sampleSheet$cleanId
...
akap11.akap11.abundance.m <- getAbundanceOfProtein(akap11.xls, 
                                               ...
                                               akap11.sampleSheet)
akap11.akap11.abundance.plot <- makeAbundancePlot(akap11.akap11.abundance.m)
ggsave("~/Google Drive/psp/analysis/plots/combined/abundance_Fus_akap11.pdf", width = pWidth, height = pHeight, units="in")
...
saveHeatMaps(all.xls, CYTOSOLIC_RIBOSOME, "ribosome")
